...
@section('content')
	...
	@if($errors->get('pendaftaran'))
		<?php 
			$pendaftaran = $errors->get('pendaftaran');
			$tagihan = $errors->get('tagihan');
		?>
					...
					<ol class="pl-3 list-decimal mt-3">
						...
						<li>Datang ke SMK Muhammadiyah Bligo dengan membawa :
							<ol class="list-inside pl-5" style="list-style: lower-alpha">
								...
								<li>Biaya pendaftaran sebesar {{ NumberHelper::toRupiah($tagihan['biaya_pendaftaran']) }} (Wajib)</li>
