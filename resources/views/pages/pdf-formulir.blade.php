...
<head>
    ...
    <link rel="stylesheet" href="/pdf/pdf-formulir.css">
</head>
<body>
                ...
                <div class="d-flex justify-content-center">
                    <div class="row w-90">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-8 d-flex flex-row">
                                            ...
                                            <div class="ml-2 mt-2 w-val">
                                                <input type="text" class="w-100" value="{{$data->jalur_pendaftaran}}">
                                            </div>
                                        </div>
                                    </div>
                                </li>
                        ...
                        <div class="col-12 small font-weight-bold mt-2 text-lowercase">
                            <span class="text-capitalize">Dengan</span> ini saya menyatakan bahwa data yang diisi dalam formulir pendaftaran ini adalah benar
                        </div>
